...
public class MyBatchRunner extends AbstractRunner {

	private static MessageCenter msgCenter = MessageCenter
			.getMessageCenter(MyBatchRunner.class);
	...
	public void runInitialize(String filepath) {
		ParametersParser parser = null;

		try {
			parser = new ParametersParser(new File(filepath));
